...
class SharedPreferenceUtil {
  ...
  static LoggedInUserModel? getUserData() {
    var user = getString(userDataKey);
    return user == "" ? null : LoggedInUserModel.fromJson(jsonDecode(user));
  }

  static Future<bool> saveUserData({LoggedInUserModel? userData}) async {
    // return putString(userDataKey, jsonEncode(userData?.toJson()));
    final sp = await SharedPreferences.getInstance();
    return sp.setString(userDataKey, jsonEncode(userData?.toJson()));
  }
}
